...
SET @new_value = '13.0.1601.5'     -- This will be replaced at build time with the sql build number
...
BEGIN
    ...
    IF (@old_value_char <> '13.0.1601.5')   -- value only used during development
    BEGIN
